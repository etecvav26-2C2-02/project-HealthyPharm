...
return [
    ...
    'entrar' => 'Entrar',
    'bem_vindo' => 'Bem-vindo',
    'logado' => 'Você está logado no sistema',
    'inicio' => 'Inicio',
    'produtos' => 'Lista',
    'cadastrar' => 'Cadastrar',
    'sair' => 'Sair',
    ...
    'confirmar_exclusao' => 'Deseja excluir?',
    'adicionar' => 'Próxima Página',
    'nome' => 'Nome do Rémedio',
...
Nosso foco principal é apoiar jovens pais e mães que estão construindo sua estabilidade financeira e buscam soluções mais acessíveis para cuidar da saúde de seus filhos. Queremos oferecer um espaço onde informação, colaboração e apoio caminhem juntos em benefício de toda a comunidade.'
]; ?>